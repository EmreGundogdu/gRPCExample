...
namespace GrpcFileStreamingExample.Services
{
    public class FileTransportService : FileService.FileServiceBase
    {
        readonly IWebHostEnvironment webHostEnvironment1;
        public FileTransportService(IWebHostEnvironment webHostEnvironment1)
        {
        ...
        {
            string path = Path.Combine(webHostEnvironment1.WebRootPath, "files");
